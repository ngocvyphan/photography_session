...
public class PhotographySession {
    ...
    public void getInformation(){
        ...
        input.nextLine();
        System.out.println("Added PhotoAlbum (y/n): ");
        addedPhotoAlbum = input.nextLine().equalsIgnoreCase("y");
        System.out.println("Added Video (y/n): ");
        addedVideo = input.nextLine().equalsIgnoreCase("y");
        System.out.println("Added ExtraEditing (y/n): ");
        addedExtraEditing = input.nextLine().equalsIgnoreCase("y");
        System.out.println("Added ExtraPrints (y/n): ");
        addedExtraPrints = input.nextLine().equalsIgnoreCase("y");
        if (addedExtraPrints){
            System.out.println("Number of extra prints: ");
            numberOfExtraPrints = input.nextInt();
            input.nextLine();
        }
    }
