DROP
DATABASE IF EXISTS cis2232_photography_session;
CREATE
DATABASE cis2232_photography_session;
use
cis2232_photography_session;
...
INSERT INTO CodeType (CodeTypeId, englishDescription, frenchDescription, createdDateTime, createdUserId,
                      updatedDateTime, updatedUserId)
VALUES (2, 'Photography Types', 'Photography Types FR', sysdate(), '', CURRENT_TIMESTAMP, '');
...
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription,
                       frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId)
VALUES (2, 3, 'Wedding', 'Wedding', 'WeddingFR', 'WeddingFR', '2015-10-25 18:44:37', 'admin', '2015-10-25 18:44:37',
        'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription,
                       frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId)
VALUES (2, 4, 'Portrait', 'Portrait', 'PortraitFR', 'PortraitFR', '2015-10-25 18:44:37', 'admin', '2015-10-25 18:44:37',
        'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription,
                       frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId)
VALUES (2, 5, 'Pet', 'Pet', 'PetFR', 'PetFR', '2015-10-25 18:44:37', 'admin', '2015-10-25 18:44:37', 'admin');
...
(
    ...
    numberOfHoursBooked int(3) NOT NULL default 0 COMMENT 'Number ofhours booked for custom package',
